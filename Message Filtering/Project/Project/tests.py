...
from Monitoring.forms import PasswordRecoveryForm, PasswordResetForm
from Monitoring.utils import get_user_model
...
class FormTests(TestCase):
    ...
    def test_username_input(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEqual(form.errors['username_or_email'],["Sorry, this user doesn't exist."])
